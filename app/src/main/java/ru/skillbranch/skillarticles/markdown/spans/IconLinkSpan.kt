...
//        val transY = y + paint.descent() - linkDrawable.bounds.bottom //translate icon to line postion
        val transY = bottom.toFloat() - linkDrawable.bounds.bottom //translate icon to line postion
        canvas.translate(x + gap / 2f, transY)
        linkDrawable.draw(canvas) //restore canvas position
        canvas.restore()
        paint.forText {
